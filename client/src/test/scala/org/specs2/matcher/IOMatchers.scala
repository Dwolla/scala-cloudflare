/* This file was copied from specs2-cats since that library relies on a more
 * modern version of cats-effect than this project currently uses.
 */
  ...
  class TimedMatcher[T](check: ValueCheck[T], duration: Option[FiniteDuration]) extends Matcher[F[T]] {
    ...
    def checkWithDuration[S <: F[T]](e: Expectable[S], d: FiniteDuration): MatchResult[S] =
      try {
        ...
        case _: TimeoutException => timeoutResult(e,d)
...
trait IOMatchers extends RunTimedMatchers[IO] {
  ...
  protected def runWithTimeout[A](fa: IO[A], d: FiniteDuration): A = scala.concurrent.Await.result(fa.unsafeToFuture(), d)
